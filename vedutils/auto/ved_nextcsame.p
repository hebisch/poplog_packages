/* --- The University of Birmingham 1996.  --------------------------------
 > File:            $poplocal/local/auto/ved_nextcsame.p
 > Purpose:         Find next location where this file and other file match
 > Author:          Aaron Sloman, May  9 1993
...
compile_mode:pop11 +varsch +defpdr -lprops :vm +prmfix  :popc -wrdflt -wrclos;
