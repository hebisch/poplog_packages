/* --- Copyright University of Birmingham 2011. All rights reserved. ------
 > File:            $usepop/pop/packages/newkit/prb/auto/prb_interact.p
...
define global vars procedure prb_readline();
    readline()
enddefine;

section $-prb prb_trace prb_untrace prb_readline => prb_interact;
...
/* --- Revision History ---------------------------------------------------
--- Aaron Sloman, Nov 25 2011
        introduced user-modifiable prb_readline for use by prb_interact
