/* --- Copyright University of Birmingham 2003. All rights reserved. ------
 > File:            $usepop/pop/packages/teaching/auto/haiku_speak.p
 > Purpose:         Use storygrammar to generate Haikus
 > Author:          Aaron Sloman, 18 Jul 2009
 > Documentation:   TEACH STORYGRAMMAR
 > Related Files:    $usepop/pop/packages/teaching/auto/haiku.p
 */
...
;;; This might be an example lexicon, for use with the above grammar
    ...
    vars haiku_lex =
        [
            ...
            [adj abrupt acrid angry avid bitter black bleak bleary
                creative crass crazy cyan dark deep
            ...
            [plural_noun
                ancestors autumns
                births Bodens clouds collisions creatures
            ...
            [verb2 aged altered arisen
                bloomed blinked Bodened burnt burst
            ...
            [exclaim
                ...
                Well Whatever Wherefore Whisper Why Woe Yea Yes]
        ];
    ...
    repeat arg times
        lvars haik;
        generate_category("haiku", haiku_gram, haiku_lex) -> haik;
        ;;; haik==>
        ;;; pr(newline);
        ;;;sysflush(poprawdevout);
        speak_espeak(haik);
